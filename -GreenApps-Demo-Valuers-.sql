...
INSERT INTO `Compra` VALUES (1,'1',1,1,10000,1,'2020-01-01 00:00:00',1);
...
INSERT INTO `Cotizacion` VALUES (1,'1',1,1,3000,NULL,'2020-01-01 00:00:00',1);
...
CREATE TABLE `DevolucionCliente` (
  `idDevolucionCliente` int(30) NOT NULL AUTO_INCREMENT,
  `numeroDevolucionCliente` varchar(30) NOT NULL,
  `idEmpleado` int(30) NOT NULL,
  `idPersona` int(30) NOT NULL,
  `totalDevolucionCliente` float NOT NULL,
  `idTipoTransaccion` int(30) NOT NULL,
  `fechaDevolucionCliente` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`idDevolucionCliente`),
  UNIQUE KEY `idDevolucionCliente_UNIQUE` (`idDevolucionCliente`),
  KEY `idEmpleadoDevolucionCliente_idx` (`idEmpleado`),
  KEY `idPersonaDevolucionCliente_idx` (`idPersona`),
  KEY `idTipoTransaccionDevolucionCliente_idx` (`idTipoTransaccion`),
  CONSTRAINT `idEmpleadoDevolucionCliente` FOREIGN KEY (`idEmpleado`) REFERENCES `Empleado` (`idEmpleado`) ON UPDATE CASCADE,
  CONSTRAINT `idPersonaDevolucionCliente` FOREIGN KEY (`idPersona`) REFERENCES `Persona` (`idPersona`) ON UPDATE CASCADE,
  CONSTRAINT `idTipoTransaccionDevolucionCliente` FOREIGN KEY (`idTipoTransaccion`) REFERENCES `TipoTransaccion` (`idTipoTransaccion`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `DevolucionCliente` VALUES (1,'1',1,1,30000,1,'2020-01-01 00:00:00');
...
CREATE TABLE `detalleDevolucionCliente` (
  `idDetalleDevolucionCliente` int(30) NOT NULL AUTO_INCREMENT,
  `idDevolucionCliente` int(30) NOT NULL,
  `idProducto` int(30) NOT NULL,
  `codigoProducto` varchar(100) NOT NULL,
  `nombreProducto` varchar(100) NOT NULL,
  `valorVentaProducto` float NOT NULL,
  `unidadesDevueltas` int(30) NOT NULL,
  `totalDetalleDevolucionCliente` float NOT NULL,
  PRIMARY KEY (`idDetalleDevolucionCliente`),
  UNIQUE KEY `idDetalleDevolucionCliente_UNIQUE` (`idDetalleDevolucionCliente`),
  KEY `idDetalleDevolucionClientePdcto_idx` (`idProducto`),
  KEY `idDetalleDevolucionClienteVenta_idx` (`idDevolucionCliente`),
  CONSTRAINT `idDetalleDevolucionClientePdcto` FOREIGN KEY (`idProducto`) REFERENCES `Producto` (`idProducto`) ON UPDATE CASCADE,
  CONSTRAINT `idDetalleDevolucionClienteVenta` FOREIGN KEY (`idDevolucionCliente`) REFERENCES `DevolucionCliente` (`idDevolucionCliente`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detalleDevolucionCliente` VALUES (1,1,1,'¡DEFAULT!','DEFAULT',3000,10,30000);
...
CREATE TABLE `DevolucionProveedor` (
  `idDevolucionProveedor` int(30) NOT NULL AUTO_INCREMENT,
  `numeroDevolucionProveedor` varchar(30) NOT NULL,
  `idEmpleado` int(30) NOT NULL,
  `idPersona` int(30) NOT NULL,
  `totalDevolucionProveedor` float NOT NULL,
  `idTipoTransaccion` int(30) NOT NULL,
  `fechaDevolucionProveedor` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`idDevolucionProveedor`),
  UNIQUE KEY `idDevolucionProveedor_UNIQUE` (`idDevolucionProveedor`),
  KEY `idEmpleadoDevolucionProveedor_idx` (`idEmpleado`),
  KEY `idPersonaDevolucionProveedor_idx` (`idPersona`),
  KEY `idTipoTransaccionDevolucionProveedor_idx` (`idTipoTransaccion`),
  CONSTRAINT `idEmpleadoDevolucionProveedor` FOREIGN KEY (`idEmpleado`) REFERENCES `Empleado` (`idEmpleado`) ON UPDATE CASCADE,
  CONSTRAINT `idPersonaDevolucionProveedor` FOREIGN KEY (`idPersona`) REFERENCES `Persona` (`idPersona`) ON UPDATE CASCADE,
  CONSTRAINT `idTipoTransaccionDevolucionProveedor` FOREIGN KEY (`idTipoTransaccion`) REFERENCES `TipoTransaccion` (`idTipoTransaccion`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `DevolucionProveedor` VALUES (1,'1',1,1,30000,1,'2020-01-01 00:00:00');
...
CREATE TABLE `detalleDevolucionProveedor` (
  `idDetalleDevolucionProveedor` int(30) NOT NULL AUTO_INCREMENT,
  `idDevolucionProveedor` int(30) NOT NULL,
  `idProducto` int(30) NOT NULL,
  `codigoProducto` varchar(100) NOT NULL,
  `nombreProducto` varchar(100) NOT NULL,
  `valorVentaProducto` float NOT NULL,
  `unidadesDevueltas` int(30) NOT NULL,
  `totalDetalleDevolucionProveedor` float NOT NULL,
  PRIMARY KEY (`idDetalleDevolucionProveedor`),
  UNIQUE KEY `idDetalleDevolucionProveedor_UNIQUE` (`idDetalleDevolucionProveedor`),
  KEY `idDetalleDevolucionProveedorPdcto_idx` (`idProducto`),
  KEY `idDetalleDevolucionProveedorVenta_idx` (`idDevolucionProveedor`),
  CONSTRAINT `idDetalleDevolucionProveedorPdcto` FOREIGN KEY (`idProducto`) REFERENCES `Producto` (`idProducto`) ON UPDATE CASCADE,
  CONSTRAINT `idDetalleDevolucionProveedorVenta` FOREIGN KEY (`idDevolucionProveedor`) REFERENCES `DevolucionProveedor` (`idDevolucionProveedor`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detalleDevolucionProveedor` VALUES (1,1,1,'¡DEFAULT!','DEFAULT',3000,10,30000);
...
INSERT INTO `Servicio` VALUES (1,1,'DEFAULT',1,1,'DEFAULT',1,1,15000,'0',1,'2020-01-01 00:00:00',1);
...
-- Dump completed on 2020-03-30 00:00:00
