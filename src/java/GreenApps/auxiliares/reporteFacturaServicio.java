...
public class reporteFacturaServicio {
    ...
    public void getReporte(String ruta, Integer idP, Integer idE, Integer idS) throws ClassNotFoundException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
